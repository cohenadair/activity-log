...
It is data, not code: `app-store-screenshots.json` is this project's slide
deck (copy, layout, theme), and `screenshots/` holds the raw device
captures it references. Editing screenshots for this app happens in the
shared tool's editor, not by hand-editing files here.
