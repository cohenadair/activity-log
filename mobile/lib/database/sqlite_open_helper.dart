...
class SQLiteOpenHelper {
  ...
  static const List<String> _schema3 = [
    """
    CREATE TABLE report (
      id TEXT PRIMARY KEY,
      name TEXT UNIQUE NOT NULL,
  ...
  static const List<String> _schema4 = [
    """
    ALTER TABLE activity ADD COLUMN is_archived BOOLEAN DEFAULT 0
    """,
    """
    ALTER TABLE activity ADD COLUMN is_hidden_from_stats BOOLEAN DEFAULT 0
    """,
  ];

  static const List<String> _schema5 = [
    "ALTER TABLE activity ADD COLUMN created_at INTEGER",
    """
    UPDATE activity
    SET created_at = (
      SELECT MIN(start_timestamp)
      FROM session
      WHERE session.activity_id = activity.id
    )
    """,
  ];
